...
function searchDnsSecKeyExample() {
	...
	try {
		 $response = $ascioClient->SearchDnsSecKey(new ascio\SearchDnsSecKey($sessionId, $criteria));
        } catch (\Exception $e) {
    		echo ("[".$e->faultcode . "] ". $e->faultstring);
	    	return;
        
        }
	$result = $response->getSearchDnsSecKeyResult();
	echo "Code: ".$result->getResultCode()."\n";
	echo "Message: ".$result->getMessage()."\n";  
	return $result;
}
searchDnsSecKeyExample();