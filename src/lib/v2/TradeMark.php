...
class TradeMark extends v2\TradeMark implements ApiObjectInterface {
    /**
     * model\TradeMark $db The Database
     */
    public $db;
    private $old;
    private $handle;
     ...
     * @return TradeMark 
     */
    public function get($handle=null) : TradeMark   {
        try {
     ...
     * @return TradeMark 
     */
    public function getApi($domainHandle=null) : TradeMark  {
        ...
        Tools::mergeProperties($domain->getTradeMark()(),$this);
        return $this;
    } 
     /**
     * Get the Data via API
     ...
     * @return TradeMark 
     */
    public function getDb($handle=null) : TradeMark {
